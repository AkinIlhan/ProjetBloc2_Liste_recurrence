...
class RecurrenceModel {
    ...
    public function ajouterRecurrence($sujet, $description, $dateAnniv, $frequence, $rappel, $idLieu, $uniteFrequence, $uniteRappel) {
        ...
        // Condition qui permet de vérifier si la date envoyé est correcte 
        // -1 jour pour inclure la date d'aujourd'hui
    ...
    // Méthode permettant de convertir la valeur de fréquence en jours pour la logique de rappel et de fréquence
