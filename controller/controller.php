<?php
    ...
    require_once(__DIR__ . '/../modele/demande.php');
...
function accueil()
{
    try {
       ...
       // Instancier le modèle RecurrenceModel
       $db = new Database(); // true = base de test, sinon laisse en false pour la prod
       ...
       $result = $stmt->fetchAll(PDO::FETCH_ASSOC);
        require "view/liste_maintenance.php";
...
function ajouterMaintenance() {
    ...
    require "view/formulaire_ajout.php";
...
function modifierMaintenance() {
        ...
        $id_maintenance = filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT);
        if (!$id_maintenance) {
        ...
        require "view/formulaire_mis-a-jour.php";
}
?>