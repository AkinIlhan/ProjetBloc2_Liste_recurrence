...
<body>
    ...
    <div class="frm-add-recurr">
        <form class="frmAdd-recurr" name="frmAdd" action="index.php?update_recurr=1&id=<?php echo $maintenance['id_recurrence']; ?>" method="POST">
        ...
        <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
            ...
            <div class="demo-form-row">
                <a href="index.php" class="retour_liste_recurr">Retour à la liste</a>
            </div>
